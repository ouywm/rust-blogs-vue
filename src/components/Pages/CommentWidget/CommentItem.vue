    ...
    <div class="comment-main">
      ...
      <div class="comment-info">
        ...
        <div class="actions">
          ...
          <el-button v-auth="'edit'" type="text" size="small" @click="$emit('edit-comment', comment.id)">
            编辑
          </el-button>
          <el-button v-auth="'delete'" type="text" size="small" style="color: var(--el-color-danger)" @click="$emit('delete-comment', comment.id)">
            删除
          </el-button>
        </div>
      </div>
...
<script setup lang="ts">
  ...
  const emit = defineEmits<{
    ...
    (event: 'add-reply', commentId: number, replyContent: string): void
    (event: 'edit-comment', commentId: number): void
    (event: 'delete-comment', commentId: number): void
  }>()
  ...
  const addReply = (commentId: number, replyContent: string) => {
    emit('add-reply', commentId, replyContent)
    replyContent.value = ''
  }
